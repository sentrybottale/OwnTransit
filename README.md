...
Network failures retry automatically with retained pairing and bounded backoff,
including HTTP 429 throttling. A broken SSH session still needs a new SSH command;
old bytes are never replayed. See [operational limits](PAIRING_INSTALL.md#operational-limits).
