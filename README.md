...
## Install the 0.1.7 development preview
...
Apple-silicon macOS uses the [signed client archive](https://github.com/sentrybottale/OwnTransit/releases/tag/v0.1.7).
...
Use the same 0.1.7 installer above for each installed role. It preserves pairing
state and accepts known 0.1.1/0.1.2/0.1.3/0.1.5/0.1.6 preview packages; stable 0.1.0 remains
