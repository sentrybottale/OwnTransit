...
require_text scripts/qualify/linux-amd64-vm.sh '"protected_hardlinks":true'
require_text scripts/qualify/linux-amd64-vm.sh 'assert_platform_mutation_lock'
require_text scripts/qualify/linux-amd64-vm.sh 'platform.v1.lock'
require_text scripts/qualify/linux-amd64-vm.sh '"platform_mutation_lock":true'
...
require_text scripts/qualify/linux-amd64-vm.sh 'release_sequence=$(build_input release_sequence)'
require_text scripts/qualify/linux-amd64-vm.sh '--release-sequence "$release_sequence"'
require_text scripts/qualify/linux-amd64-vm.sh 'assert_status_release_sequence "$connector_status_json" "$release_sequence"'
require_text scripts/qualify/linux-amd64-vm.sh 'assert_status_release_sequence "$reboot_status_json" "$recorded_release_sequence"'
require_text scripts/qualify/linux-amd64-vm.sh '"release_sequence":%s'
if grep -Fq -- '--release-sequence 1' scripts/qualify/linux-amd64-vm.sh; then
