...
Linux installation uses `/opt/owntransit-preview/0.1.6`, separately named
...
For 0.1.6, existing connector installation prints a service restart command instead
