...
func TestMacInstallerIsolatedLifecycle(t *testing.T) {
	...
	top := "owntransit-preview-0.2.0-darwin-arm64"
	...
	members := []string{"DEVELOPMENT.txt", "install-preview-linux.sh", "install-preview-macos.sh", top + ".tar.gz", "owntransit-preview-0.2.0-linux-amd64.tar.gz", "owntransit-preview-0.2.0-linux-arm64.tar.gz"}
