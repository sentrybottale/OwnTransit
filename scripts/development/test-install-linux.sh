...
bundle=/root/owntransit-preview-0.6.1-linux-$arch
...
test "$(readlink /usr/local/bin/owntransit-preview)" = /opt/owntransit-preview/0.6.1/client/owntransit
...
test -x /opt/owntransit-preview/0.6.1/connector/owntransit-connector
test "$(readlink /usr/local/bin/owntransit-connector-preview)" = /opt/owntransit-preview/0.6.1/connector/owntransit-connector
test -f /etc/systemd/system/owntransit-connector-pair.service
grep -Fqx 'ExecStart=/opt/owntransit-preview/0.6.1/connector/owntransit-connector pair serve --state /var/lib/owntransit-pair' /etc/systemd/system/owntransit-connector-pair.service
...
sed -e 's/0\.6\.1/0.1.2/g' -e 's/^Type=notify$/Type=simple/' \
...
sed 's/0\.6\.1/0.1.3/g' "$unit" > /tmp/preview-013-unit
...
grep -Fqx 'ExecStart=/opt/owntransit-preview/0.6.1/connector/owntransit-connector pair serve --state /var/lib/owntransit-pair' "$unit"
sed 's/0\.6\.1/0.1.6/g' "$unit" > /tmp/preview-016-unit
...
sed 's/0\.6\.1/0.1.7/g' "$unit" > /tmp/preview-017-unit
...
sed 's/0\.6\.1/0.2.0/g' "$unit" > /tmp/preview-020-unit
...
sed 's/0\.6\.1/0.3.0/g' "$unit" > /tmp/preview-030-unit
...
sed 's/0\.6\.1/0.4.0/g' "$unit" > /tmp/preview-040-unit
...
sed 's/0\.6\.1/0.5.0/g' "$unit" > /tmp/preview-050-unit
...
sed 's/0\.6\.1/0.6.0/g' "$unit" > /tmp/preview-060-unit
install -m 0644 /tmp/preview-060-unit "$unit"
"$bundle/install-linux.sh" --bundle "$bundle" --role connector >/tmp/connector-060-upgrade.out
grep -Fqx 'ExecStart=/opt/owntransit-preview/0.6.1/connector/owntransit-connector pair serve --state /var/lib/owntransit-pair' "$unit"
...
test ! -e /opt/owntransit-preview/0.6.1/relay || fail 'alias conflict partially installed relay role'
...
test -x /opt/owntransit-preview/0.6.1/relay/owntransit-relay
test -f /opt/owntransit-preview/0.6.1/relay/owntransit-relay.oci.tar
test "$(readlink /usr/local/bin/owntransit-relay-preview)" = /opt/owntransit-preview/0.6.1/relay/owntransit-relay
...
test -x /usr/local/bin/owntransit-relay-preview && test -f /opt/owntransit-preview/0.6.1/relay/owntransit-relay.oci.tar || fail 'scoped removal removed shared software'
...
# The latest published predecessor is accepted without removing its software.
install -d -m 0755 /opt/owntransit-preview/0.6.0/client
install -m 0755 /opt/owntransit-preview/0.1.1/client/owntransit /opt/owntransit-preview/0.6.0/client/owntransit
ln -sfn /opt/owntransit-preview/0.6.0/client/owntransit /usr/local/bin/owntransit-preview
"$bundle/install-linux.sh" --bundle "$bundle" --role client >/tmp/client-060-upgrade.out
test "$(readlink /usr/local/bin/owntransit-preview)" = /opt/owntransit-preview/0.6.1/client/owntransit
...
install -m 0644 /opt/owntransit-preview/0.6.1/connector/service.template "$unit"
...
test "$(cat /usr/local/bin/owntransit)" = unmanaged-command
test ! -e /opt/owntransit-preview/0.6.1/client
"$bundle/install-linux.sh" --bundle "$bundle" --role client --action uninstall
"$bundle/install-linux.sh" --bundle "$bundle" --role client
