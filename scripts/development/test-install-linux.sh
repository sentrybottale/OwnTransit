...
bundle=/root/owntransit-0.8.0-linux-$arch
...
test -x /opt/owntransit/0.8.0/client/owntransit-client
test "$(readlink /usr/local/bin/owntransit-client)" = /opt/owntransit/0.8.0/client/owntransit-client
...
test -x /opt/owntransit/0.8.0/target/owntransit-target
test "$(readlink /usr/local/bin/owntransit-target)" = /opt/owntransit/0.8.0/target/owntransit-target
test -f /etc/systemd/system/owntransit-target.service
grep -Fqx 'ExecStart=/opt/owntransit/0.8.0/target/owntransit-target serve --state /var/lib/owntransit-pair' /etc/systemd/system/owntransit-target.service
...
sed -e 's/0\.8\.0/0.6.1/g' -e 's@/opt/owntransit/@/opt/owntransit-preview/@g' \
...
test ! -e "$legacy_unit"
grep -Fqx 'ExecStart=/opt/owntransit/0.8.0/target/owntransit-target serve --state /var/lib/owntransit-pair' "$unit"
# An existing canonical 0.7 installation must also upgrade without re-pairing.
install -d -m 0755 /opt/owntransit/0.7.0/target
install -m 0755 "$bundle/owntransit-target" /opt/owntransit/0.7.0/target/owntransit-target
sed 's/0\.8\.0/0.7.0/g' "$unit" > /tmp/target-070.service
install -m 0644 /tmp/target-070.service "$unit"
rm -- /usr/local/bin/owntransit-target
ln -s /opt/owntransit/0.7.0/target/owntransit-target /usr/local/bin/owntransit-target
...
test ! -e /opt/owntransit/0.8.0/relay || fail 'alias conflict partially installed relay role'
...
test -x /opt/owntransit/0.8.0/relay/owntransit-relay
test -f /opt/owntransit/0.8.0/relay/owntransit-relay.oci.tar
test "$(readlink /usr/local/bin/owntransit-relay)" = /opt/owntransit/0.8.0/relay/owntransit-relay
...
test -x /usr/local/bin/owntransit-relay && test -f /opt/owntransit/0.8.0/relay/owntransit-relay.oci.tar || fail 'scoped removal removed shared software'
...
for role in client relay; do
  install -d -m 0755 "/opt/owntransit/0.7.0/$role"
  install -m 0755 "$bundle/owntransit-$role" "/opt/owntransit/0.7.0/$role/owntransit-$role"
  rm -- "/usr/local/bin/owntransit-$role"
  ln -s "/opt/owntransit/0.7.0/$role/owntransit-$role" "/usr/local/bin/owntransit-$role"
  "$bundle/install-linux.sh" --bundle "$bundle" --role "$role" >/tmp/canonical-upgrade.out
  test "$(readlink "/usr/local/bin/owntransit-$role")" = "/opt/owntransit/0.8.0/$role/owntransit-$role"
  test -x "/opt/owntransit/0.7.0/$role/owntransit-$role"
done
...
install -m 0644 /opt/owntransit/0.8.0/target/service.template "$unit"
...
test "$(cat /usr/local/bin/owntransit)" = unmanaged-command
test ! -e /opt/owntransit/0.8.0/client
"$bundle/install-linux.sh" --bundle "$bundle" --role client --action uninstall
"$bundle/install-linux.sh" --bundle "$bundle" --role client
